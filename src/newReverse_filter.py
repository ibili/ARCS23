...
if __name__ == '__main__':
        ...
        for contig in contigs:
            ...
            if rr in ctg2scf:
                ...
                if sid in flag[idx]:
                    ...
                    flag[idx][sid] = 1
    #flag idx sid two lable of scf, check the number of revese contigs
    '''
    print "flag:"
    ...
    for idx, l in sortedLens:
        ...
        for sid, w in flag[idx].iteritems():
            '''
            if (idx == 39 and sid == 33624):
                print "39, 33624",w,len(scfs[sid][0]),l,scflens[sid]
            if ((w <= 1 and len(scfs[sid][0]) > 1) or (l < scflens[sid])):
                print "not exactly reverse",idx,sid,w,len(scfs[sid][0])
                print "idx length, sid length",l,scflens[sid]
                continue
            ''' 
            #change by liyanbo, 
